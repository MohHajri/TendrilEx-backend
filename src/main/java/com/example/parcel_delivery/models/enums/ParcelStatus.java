...
public enum ParcelStatus {
    CREATED, // when parcel is just created in the system by sender and has not been drop off to a cabinet yet.

    AWAITING_INTRA_CITY_PICKUP, // after a parcel is dropped off to a cabinet, it will wait for an intra driver to take it ( to reciepent or ot a departure storage)

    AWAITING_INTER_CITY_PICKUP, // after an inter parcel is delivered to a departure storage, it will wait for for a pickup by an inter-city driver to the destination storage
